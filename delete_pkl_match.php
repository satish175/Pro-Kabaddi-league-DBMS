...
while($row=mysqli_fetch_assoc($result))
{
	...
	?>
	<td><a href="delete_pkl_match.php?delete_id=<?php echo $row['Match_Id']; ?>" onclick="return confirm('Are you sure?');"> Delete</a></td>
	</tr>
	<?php
}
?>
...
{
	$did=$_GET['delete_id'];
	mysqli_query($con,"DELETE FROM pkl_match WHERE Match_Id='$did'");
	header("location:delete_pkl_match.php");
}
?>
